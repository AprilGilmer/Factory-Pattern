namespace FactoryPattern
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Hello, please enter a number of wheels.");
            string userResponse = Console.ReadLine();
            int userResponseParsed = Int32.Parse(userResponse);
            IVehicle vehicle = VehicleFactory.GetVehicle(userResponseParsed);
            vehicle.Drive(); 
            ...
            Complete this using an interface. You must have at least 2 subclasses. For instance, if I type 4 into the console, 
            the program would create a car or truck, or if someone types 2 it would create a motorcycle.
